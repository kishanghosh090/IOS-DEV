...
//username = ""
//let accountId = 1234; // constant
//
////accountId = 123
//
//var numberOfLoginInADay: Int = 34
//
//print(numberOfLoginInADay)
//
...
// arrays
var myChais: [String] = ["elychi tea", "ginger", "aaa"]
var teas: Array<String> = Array<String>()
// teas.insert("")
print(myChais)
teas.append("masala tea")
print(myChais.isEmpty)
print(myChais.count)

//myChais.map()

myChais.insert("myname", at: myChais.endIndex)
print(myChais)

myChais.sort()//  change the existing array
